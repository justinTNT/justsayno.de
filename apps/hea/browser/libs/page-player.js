...
function PagePlayer(oConfigOverride) {
  ...
  sm.url = '/browser/swf/'; // path to directory containing SM2 SWF
  ...
  if (this.config.useFavIcon) {
	if (isFirefox || isOpera) {
	  ...
	  // browser doesnt support doing this
...
// justin added this to stop last sound and remove old sounds
        if (self.lastSound) {
