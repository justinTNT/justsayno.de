...
(function() {
  ...
  showPaginatedList = function(env, req, res, next, cfg, skip, cb, skipRoute) {
    ...
    console.dir(cfg.sort);
    console.dir(cfg.limit);
    return cfg.model.find(newq, cfg.fields).sort(cfg.sort).limit(cfg.limit).skip(skip).exec(function(err, docs) {
      var href, objs, p;
      if (err) {
